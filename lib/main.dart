          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(labelText: 'WhatsApp com DDD (Ex: 62999998888) *', border: OutlineInputBorder()),
              ),
              const SizedBox(height: 12),
              TextField(
                controller: obsCtrl,
                ...
                if (clientesFiltrados.isEmpty) {
                  return const Center(
                    child: Padding(
                      ...
                      child: Text('Nenhum cliente encontrado.', style: TextStyle(color: Colors.grey)),
                    ),
                  );
                }
...
class _ClientBookingScreenState extends State<ClientBookingScreen> {
  ...
  Future<void> _confirmarAgendamento() async {
    ...
    try {
      // Auto-cadastro / sincronização na base de clientes
